...
test_that("lionessPy() function works", {
  ...
  #expect_message(lionessPy(T4_expression_file_path, end_sample=1), regexp="motif network", fixed=TRUE)
  
  # test 3: check message when PPI is not provided
  #expect_message(lionessPy(T4_expression_file_path,motif_file_path, end_sample=1), regexp="No PPI", fixed=TRUE)
