...
```{r,message=FALSE,warning=FALSE}
panda_results_LCL <- panda.py(expr_file = "pandaExprLCL.txt" , motif_file = "./motif_GTEx.txt", ppi_file = "./ppi_GTEx.txt", modeProcess="legacy", remove_missing = TRUE)
```
...
```{r,warning=FALSE}
#run PANDA
panda_results_wblood <- panda.py(expr_file = "pandaExprWholeBlood.txt" , motif_file = "./motif_GTEx.txt", ppi_file = "./ppi_GTEx.txt", modeProcess="legacy", remove_missing = TRUE)
```
