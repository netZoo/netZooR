...
```{r}
panda_results_LCL <- panda.fast(e = "pandaExprLCL.txt" , m = motif_file_path, ppi = ppi_file_path, rm_missing = TRUE)
```
...
```{r}
lionessLCL <- lioness(e = "pandaExprLCL.txt" , m = motif_file_path, ppi = ppi_file_path, rm_missing = TRUE, save_fmt = "txt")
```
