...
#'
#' @return A data frame with columns representing each sample, rows representing the regulator-target pair in PANDA network generated by \code{\link{panda.py}}. 
...
#' @import reticulate
#' @export
lioness.py <- function(expr_file, motif_file=NULL, ppi_file=NULL, computing="cpu", precision="double", save_tmp=TRUE, modeProcess="union", remove_missing=FALSE, start_sample=1, end_sample="None", save_single_network=FALSE, save_dir="lioness_output", save_fmt='npy'){
...
#'     pandaToyData$expression[,1:10],pandaToyData$ppi,hamming=.1,progress=FALSE)
#' @references
