...
#' in the paper. 
#' Additionally, there are 2 modes to run MONSTER:
...
#' contain the concatenated gene regulatory networks. Alternatively, see the `domonster`
#' function for a quick-start way to run this mode.
...
#' If `motif` is set to `NA`, MONSTER will be run in pre-computed gene regulatory network mode, in which case
