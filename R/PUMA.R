...
#'
#' This function runs the PUMA algorithm
#'
...
puma <- function(motif,expr=NULL,ppi=NULL,alpha=0.1,hamming=0.001,
  ...
  toc=proc.time()[3] - tic
  if(progress)
    message("Successfully ran PUMA on ", num.genes, " Genes and ", num.TFs, " TFs.\nTime elapsed:", round(toc,2), "seconds.")
